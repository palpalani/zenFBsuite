...
Installation
============
1) Upload the zenFBSuite.php to your zenphotodir/plugins folder.
2) Enter options via admin backend.
3) Edit theme files to insert appropriate calls where you would like the template functions to appear.
